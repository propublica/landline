(function(){
  ...
  MapCanvas.prototype.createMap = function(locality) {
    var data;
    var that     = this;
    var defaults = MapCanvas.DEFAULTS;
    if (locality === "states")   data = window.MapperStates;
    if (locality === "counties") data = window.MapperCounties;
    for (i = 0; i < defaults.length; i++) {
